...
describe('ProductDetailsComponent', () => {
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      schemas: [CUSTOM_ELEMENTS_SCHEMA], // Handle custom elements like app-text
      providers: [
        { provide: AppCartService, useValue: appCartServiceSpy }
      ]
    }).compileComponents();
  ...
  it('should initialize quantity options correctly', () => {
    fixture.detectChanges();
    expect(component.quantityOptions.length).toBe(10); // Should cap at 10
  ...
  it('should display product details correctly', () => {
    ...
    // Check if the Posted By information is displayed correctly
